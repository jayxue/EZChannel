/**
 * This class is contributed by Andrew Halberstadt. See http://ahal.ca/blog/2011/android-expandablepanel/. 
 */

package com.wms.opensource.ezchannel.view;
...
public class ExpandablePanel extends LinearLayout {
    ...
    public ExpandablePanel(Context context, AttributeSet attrs) {
        ...
        mAnimationDuration = 500;	//a.getInteger(R.styleable.ExpandablePanel_animationDuration, 500);
    ...
    public void setTypeface(Typeface tf) {
    	((TextView) mContent).setTypeface(tf);
    }
    ...
    protected void onFinishInflate() {
        ...
        // Also set the OnclickListener to the content view
        mContent.setOnClickListener(panelToggler);
    }
